...
import Chudethaoluan from "./components/Teacher/Forum/Chudethaoluan/Chudethaoluan";
...
import DanhSachTestKhoaHoc from "./components/Teacher/DanhSachBaiKT/DanhSachBaiKiemTra";
import DanhSachTest from "./components/Teacher/QuanLyBaiKT";
import DanhSachBaiLam from "./components/Teacher/DanhSachBaiLam/DanhSachBaiLam";

import CalendarDeadline from "./components/Calendar/CalendarDeadline";

import ProfileClassAdmin from "./components/ClassAdmin/ThongTinCaNhan/ProfileClassAdmin";
import QuanLyRoadMap from "./components/Teacher/QuanLyRoadmap";
import DocumentRoadmap from "./components/Teacher/ChiTietCourse/DocumentRoadmap/DocumentRoadmap";
  ...
  return (
    <Router>
      <Switch>
        ...
        <Route path="/course/:idCourse" exact component={Chitietkhoahoc} />
        ...
        <Route path="/student/thongtinkhoahoc" exact component={InfoCourse} />
        ...
        <Route path="/student/chitietkhoahoc" exact component={ChiTietCourse} />
        ...
        <Route path="/diendan" exact component={Forum} />
        <Route path="/diendan/thaoluan" exact component={Chudethaoluan} />
        ...
        <Route path="/classadmin/profile" exact component={ProfileClassAdmin} />
        <Route
        ...
        <Route
          path="/danhsachbaikiemtra"
          exact
          component={DanhSachTestKhoaHoc}
        />

        <Route path="/danhsachbailam" exact component={DanhSachBaiLam} />
        <Route path="/teacher/danhsachbaiKT" exact component={DanhSachTest} />

        <Route path="/quanlyroadmap" exact component={QuanLyRoadMap} />

        <Route
          path="/document/:idRoadmapContent"
          exact
          component={DocumentRoadmap}
        />
      </Switch>
    </Router>
  );
