...
function Home() {
    ...
    useEffect(() => {
        callApi(`Course/searchCourse?searchCourse=&pageSize=19&pageNumber=1`, "GET").then((res) => {
    ...
    const search = (e) => {
      ...
      callApi(
        `Course/searchCourse?searchCourse=${find}&pageSize=19&pageNumber=1`,
        "GET"
      ).then((res) => {
        // console.log(res.data.data[0].name)
        setCourse(res.data.data);
