...
function Chitietkhoahoc(props) {
    ...
    useEffect(() => {
        ...
        callApi(
          `Course/getInformationCourse/${idCourse}`,
          "GET"
        ).then((res) => {
        ...
        <div className="wrap">
            ...
            <div className="card-content">
                <div className="card-top">
                    ...
                    <span><AiOutlineClockCircle style={{marginTop:'-5px', marginRight:'5px'}}/>Thời lượng: {course.duration} ngày</span>
                ...
                <div className="card-bottom">
                    ...
                    <Link to="/teacher/danhsachsinhvien" style={{textDecoration:'none'}}>
                      <button className="card-live">Xem danh sách sinh viên</button>
                    </Link>
                   
                    <Link to="/teacher/danhsachbaiKT" style={{textDecoration:'none'}}>
                         <button className="card-live">Danh sách các bài kiểm tra</button>
                    </Link>

                    <Link to="/teacher/quanlykehoach" style={{textDecoration:'none'}}>
