        ...
        <Wrapper> 
            ...
            <Info>
                ...
                <div style={{marginBottom:'10%', position: "absolute",
                    ...
                    <h6>Bắt đầu: 9h30AM-03/04/2021</h6>
                    <h6>Kết thúc: 12h00AM-04/04/2021</h6>
                </div>
                <h5 style={{marginBottom:'10%', position: "absolute",
                    left: "48%", marginTop:"60%", width:'30%', color:'red'}}>Điểm: 10/10</h5>
