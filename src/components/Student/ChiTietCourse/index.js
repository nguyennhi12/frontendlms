...
const InfoCourse = () =>{ 
    ...
    return(
        <Wrapper>        
            ...
            {
                isMentor &&  <Button href={`/quanlydiem?idCourse=${idCourse}`} style={{position:'absolute', right:'18%', marginTop:'10%' }}>Chấm điểm</Button> 
            }
            ...
            <Assiment>                
                {
                    roadmapcontent == null ?console.log('null'):
                        ...
                        <NoiDungAss position={position} title={roadmapcontent.createAssignment[positionass]} idcourse={course.id}  idstudent={user.userId} positionass={positionass}></NoiDungAss>
