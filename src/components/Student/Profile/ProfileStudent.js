  ...
  return (
    ...
    <div style={{ display: "flex" }}>
      ...
      <div className="profile">
        <h5 className="student__profile-title">CHI TIẾT PROFILE</h5>
        <div className="content-wrap">
          {imgshow != null && <img src={imgshow} className="avatar_student" />}
          {imgshow == null && (
            <span className="avatar_student">Chưa có Avatar</span>
          )}
          ...
          <div className="wrap-button-student">
            ...
            <button className="button button_changepass" onClick={updateInfo}>Lưu</button>
          </div>
        </div>
      </div>
    </div>
